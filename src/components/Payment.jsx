                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-12">
                                ...
                                <nav>
                                    <ol class="breadcrumb  px-1 ">
                                        <li class="breadcrumb-item  look">
                                            <a class='text-dark font-weight-bold' href="#">Cart</a>
                                        </li>
                                        <li class="breadcrumb-item text-black look">
                                            <a class='text-dark' href="#">Info</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="col-lg-7  mb-2 mt-3 mb-3">
                            <ul class="list-group ">
                                ...
                                <li class="list-group-item">Contact<a class="look_a" href="#">Change</a><p class="discrip_look">info@gmail.com</p></li>
                                <li class="list-group-item">Ship to<a class="look_a" href="#">Change</a><p class="discrip_look">pakisntrabsjajsdhn nbhsaau kkdjsdiu </p></li>

                                <li class="list-group-item">Shipping time<p class="discrip_look pt-2 fw-bold">3-4 working days</p></li>
                            </ul>
                        </div>
                        <div class="col-lg-12 mt-4">
                            ...
                            <div class="card mt-3 border-bottom">
                                <a class="re_look fw-bold m-4 look_meth" data-bs-toggle="collapse" href="#Creditcard"
                                    role="button" aria-expanded="false" aria-controls="reviewform">
                                    <div class="d-flex justify-content-between">
                                        <p class=" mb-2 re_look">Credit card</p>
                                        <img src="https://s.pngkit.com/png/small/271-2714101_my-best-buy-visa-card-credit-card.png" height="30px" />
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card border-bottom mt-3">
                            <a class="re_look fw-bold m-4 look_meth " data-bs-toggle="collapse" href="#jazzcash"
                                role="button" aria-expanded="false" aria-controls="reviewform">
                                <div class="d-flex justify-content-between">
                                    <p class=" mb-2 re_look"> JazzCash</p>
                                    <img src="https://www.pngkit.com/png/detail/291-2911793_jazz-cash-jazz-logo.png" height="30px" />
                                </div>
                            </a>
                        </div>
                        <div class="collapse" id="jazzcash">
                            <div class="card">
                                <div class="col-auto align-self-end mt-sm-0 mt-4"><button class="btn btn-block btn-danger ml-2 mt-md-0 mt-3">SUBMIT</button></div>
                            </div>
                        </div>
                        <div class="card  border-bottom mt-3">
                            <a class="re_look fw-bold m-4 look_meth " data-bs-toggle="collapse" href="#easypaisa"
                                role="button" aria-expanded="false" aria-controls="reviewform">
                                <div class="d-flex justify-content-between">
                                    <p class=" mb-2 re_look">Easypaisa</p>
                                    <img src="https://www.vhv.rs/dpng/d/473-4736946_easypaisa-logo-png-transparent-png.png" height="30px" />
                                </div>
                            </a>
                        </div>
                            ...
                            <div className="col-lg-5 col-md-12 mt-4">
                                ...
                                <div className="d-flex align-items-center py-2 justify-content-between">
                                    ...
                                    <div className="ml-auto d-flex">
                                        <div className="font-weight-bold">Rs.{order.subtotal + order.shipping.charges}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row d-flex justify-content-between pt-5 pb-5 mb-5">
                        <div class="col-6 mb-3 mt-3 ">
                            <a class="look_return" href="#"><i class="fas fa-angle-left"></i> Return to shipping </a>
                        </div>
                        <div class="col-6 mb-3 mt-3 text-end">
                            <button type="button" class="btn btn-danger  ">Continue Shipping</button>
                        </div>
                    </div>
                </div>
            </div>
