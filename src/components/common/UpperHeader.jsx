        ...
        <div className="row justify-content-end">
          <div className="col-5">
            {!user && (
              <Link to="/login">
                <FontAwesomeIcon
                  className="mt-2 icon_s_look mx-1"
                  icon={faUser}
                />
                <span className="s_look">Sign in</span>
              </Link>
            )}
            {user && (
              <Link to="/account">
                <FontAwesomeIcon
                  ...
                  icon={faUser}
                />
                <span className="s_look">{user.username}</span>
              </Link>
            )}
          </div>
          <div className="col-6">
            ...
            <Link to="/cart">
              <FontAwesomeIcon
                className="fa-cart-plus icon_s_look mx-1"
                icon={faCartPlus}
              />
              <span className="s_look ">Cart</span>
            </Link>
          </div>
        </div>
      </div>
